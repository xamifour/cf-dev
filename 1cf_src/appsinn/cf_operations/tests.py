...
class AttendanceGenerateReportViewTests(OperationsFixturesMixin, TestCase):
    def test_scope_fields_are_autocomplete(self):
        ...
        self.assertContains(response, 'class="cf-autocomplete"')
        self.assertContains(response, 'id="id_organization"')
        self.assertContains(response, 'id="id_branch"')
        self.assertContains(response, 'id="id_zone"')
        self.assertContains(response, 'id="id_subgroup"')
        self.assertContains(response, "report_autocomplete.js")
